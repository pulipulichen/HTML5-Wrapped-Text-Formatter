...
c=[];console.log(d);var l=2;1===d.length%2&&(l=1);for(var h=0,r=d.length;h<r;h+=l){var e=d[h];2===l&&(e=e+", "+d[h+1]);console.log(e);var e=e.split("&").join(""),m=e.indexOf(", ");if(-1<m)var t=e.substr(0,m).trim(),u=e.slice(m+1,e.length).trim(),e=t+"\t"+u;c.push(e)}a=c.join("\n")}var a=a.replace(/\[.*?\]/g,""),a=a.replace(/\(.*?\)/g,""),d=a=a.replace(/\{.*?\}/g,""),a=encodeURIComponent(a),p="https://translate.google.com.tw/#"+b.source_lang.value+"/"+b.target_lang.value+"/",a=p+a,f=b.output_style.value;
